...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="../../css/stail-success-ccard.css">
        <link href='https://fonts.googleapis.com/css?family=Palanquin' rel='stylesheet'>
        <title>Payment Success - Credit Card</title>
    ...
    <body>
        <main>
            <div class="container">
                <div class="header">
                    <img src="../../resources/logo_echanem.png" alt="Credit Card Logo">
                    <h1>Payment Successful</h1>
                    <p>Thank you for your payment!</p>
                </div>
                <div class="details">
                    <p>Order ID: <?php echo $order_id; ?></p>
                    <p>You have successfully paid using your Credit Card.</p>
